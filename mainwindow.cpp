	...
	ui(new Ui::MainWindow)
{
	...
	ui->task_mdi->addWidget(mdi_area);
	mdi_area->addSubWindow(new QTextEdit(this));
	...
	QAction*	print_doc = file_menu->addAction("Print");
	connect(print_doc, SIGNAL(triggered()), this, SLOT(print_document()));

	file_menu->addAction("Exit", qApp, SLOT(quit()));
